...
set tracefile [open simpleX.tr w]
$ns_ use-newtrace
$ns_ trace-all $tracefile

set namfile [open simpleX.nam w]
...
$ns_ at 4.0 "$node_(2) setdest 700.0 200.0 100.0"
...
# NULL Null Agent to receive Packets for Node 3
